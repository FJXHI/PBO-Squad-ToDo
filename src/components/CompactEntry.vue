    ...
    <div>
      ...
      <span v-if="entry.isExpanded">
        <nav class="info-box-1d">
          <button @click="delClicked(entry)"><img alt="Delete" src="@/assets/icon_delete.svg" /></button>
          <button @click="editClicked(entry)"><img alt="Edit" src="@/assets/icon_edit.svg" /></button>
          <button @click="doneClicked(entry)"><img alt="Done" src="@/assets/icon_done.svg" /></button>
        </nav>
      </span>
    </div>
  </article>
